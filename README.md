...
| `print`  | Used to print the variables or a strings output without moving to a new line |`print <variableName>`<br><span>`print "Hello, World!"`</span>                                                                         |                                                                                            
| `println`  |  Used to print the variables or a strings output with a newline at the end. |`println <variableName>`<br><span>`println "Hello, World!"`</span>                                                                           |                                                                                               
