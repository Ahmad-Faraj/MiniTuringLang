...
| `print`  | Used to print the variables or a strings output without moving to a new line | <i>Variable</i> : `print <variableName>` <br> <i>String</i> : `print "Hello, World!"`                                                                         |                                                                                            
| `println`  |  Used to print the variables or a strings output with a newline at the end. | <i>Variable</i> : `println <variableName>` <br> <i>String</i> : `println "Hello, World!"`                                                                           |                                                                                               
